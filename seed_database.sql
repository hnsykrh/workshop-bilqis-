...
-- Insert Default Users (Password: Admin2025!@, Staff2025!@)
...
-- Passwords fulfill all requirements: 8+ chars, uppercase, lowercase, digit, special character
-- Run this query to get correct hashes: SELECT SHA2(CONCAT('dress_rental_salt_2025_', 'Admin2025!@'), 256);
INSERT INTO Users (Username, PasswordHash, Role, FullName, Email, Phone) VALUES
('admin', SHA2(CONCAT('dress_rental_salt_2025_', 'Admin2025!@'), 256), 'Administrator', 'Shop Administrator', 'admin@dressrental.com', '0123456789'),
('staff1', SHA2(CONCAT('dress_rental_salt_2025_', 'Staff2025!@'), 256), 'Staff', 'Staff Member One', 'staff1@dressrental.com', '0198765432');
